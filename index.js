...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:dark\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5585981840891:+55 8598184-0891\n' //Nomor whatsapp kamu
            + 'END:VCARD'
...
async function starts() {
	...
	dark.on('chat-update', async (mek) => {
		try {
			...
			const premium = ["5585981840891@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net","12267740582@s.whatsapp.net"]
...
// recursos anime, random @dark domina vida
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                ...
                case 'ninjalogo':
                    ...
                    dark.sendMess(from, tod, image, { quoted: mek, caption: '*Zeus domina ✓*'})
                    break
                    case 'animemenu':
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					dark.sendMess(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT ZEUS✨* 」\n*│+ wa.me/5585981840891*╰──────*「 *ZEUS* 」*────*\n\n*_SE QUER SER ADMIN DO BOT ZEUS_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
